...
public class xmlParser{
	//Aquí van los objetos principales
	...
	public xmlParser() {
		//Aquí se desarrolla el programa
		/* Creamos una instancia del archivo data.xml */
		archivo = new File("/home/moiseg/leer/aplicaciones.xml");
		
		/*Creamos un objeto SAXBuilder que nos construirá nuestro fichero XML*/
